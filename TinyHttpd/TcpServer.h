...
namespace Tinyhttpd
{
    ...
    namespace net
    {
        ...
        using OnMessgeCallback = function<void(void *user, const char *dat, size_t size, struct sockaddr_in *connaddr, int connfd)>;
        using NewConnectCallback = function<void(void *user, struct sockaddr_in *connaddr, int connfd)>;
        using DisconnectCallback = function<void(void *user, struct sockaddr_in *connaddr, int connfd)>;
